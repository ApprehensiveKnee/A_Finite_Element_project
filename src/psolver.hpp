...
private:
  ...
  // PLEASE NOTE: the dof handler is used while iterating on the mesh elements by different threads.
  // Still none of those threads modify it, they just read it, differently for the _fe object.
