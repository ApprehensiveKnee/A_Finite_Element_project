...
public:
    ...
    Point(const double &x, const double &y, const unsigned short& boundary):
        ...
        {};
    // Array constructor
    Point(const std::array<double, DIM> coord, const unsigned short& boundary ):
        _coord(coord),
        _boundary(boundary)
        {};
...
private:
    ...
    // PLEASE NOTE: for the upcoming assumptions taken along the prject, the element class would not stictly require to 
